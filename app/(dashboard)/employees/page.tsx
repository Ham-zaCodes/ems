          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                {(
                  [
                    ["Full Name", "name", "text", "John Doe", "col-span-2"],
                    ["Email", "email", "email", "john@co.com", "col-span-2"],
                    ["Phone", "phone", "text", "+1 234 567", ""],
                    ["Position", "position", "text", "e.g. Engineer", ""],
                  ] as const
                ).map(([label, key, type, ph, cls]) => (
