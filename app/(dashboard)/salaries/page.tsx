  ...
  return (
    ...
    >
      ...
      {showModal && (
        ...
        >
          <div
            className="glass-card w-full max-w-md animate-modal-in"
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            border: `1px solid ${isSelected ? border : "rgba(255,255,255,0.12)"}`,
                            color: isSelected
                              ? color
                              : "rgba(255,255,255,0.45)",
                            boxShadow: isSelected
                              ? `0 0 16px ${glow}, inset 0 0 12px ${isPaid ? "rgba(34,197,94,0.08)" : "rgba(245,158,11,0.08)"}`
                              : "none",
